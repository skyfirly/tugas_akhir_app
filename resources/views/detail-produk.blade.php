...
<div class="container mt-5">
    ...
    <div class="row">
        ...
        <img src="{{ asset('img/charm.jpg') }}" class="card-img-top" style="height: 350px;" object-fit; contain; alt="Charm School" >
        <div class="card-body">
            <h5 class="card-title fw-bold text-danger">Princess Charm School</h5>
            <p class="card-text">Film ini bercerita tentang Blair Willows yang terpilih masuk sekolah putri.</p>
        </div>
        </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-4 mb-4">
        <div class="card h-100 shadow border-danger">
            <img src="{{ asset('img/pony.jpg') }}" class="card-img-top" style="height: 350px;" object-fit; contain;  alt="A Pony Tale" >
            <div class="card-body">
    ...
    <div class="row">
        <div class="col-md-4 mb-4">
        <div class="card h-100 shadow border-danger">
            <img src="{{ asset('img/musk.jpg') }}" class="card-img-top" style="height: 350px;" object-fit; contain; alt="Three Musketeers">
            <div class="card-body">
